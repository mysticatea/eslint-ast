/**
 * @fileoverview The AST definition for ES2020.
 */
import * as ast from "./lib/ast";
import { Definition as ES2020 } from "./es2020-definition";
/**
 * The map-like object that has all nodes and aliases.
 */
export declare type AST = ast.AST<ES2020>;
/**
...
export declare namespace AST {
    ...
    /**
     * The node type for the `BigIntLiteral` node.
     */
    ...
    /**
     * The node type for the `ImportExpression` node.
     */
 ...
 */
export declare type AliasName = ast.AliasName<ES2020>;
/**
 ...
 */
export declare type NodeName = ast.NodeName<ES2020>;
/**
 ...
 */
export declare type TypeName = ast.ASTType<ES2020>;
/**
 * The union type for all nodes.
 */
 ...
 */
export declare type ArrayExpression = ast.NodeOfType<ES2020, "ArrayExpression">;
/**
 * The node type for the ESTree `ArrayPattern` node.
 */
export declare type ArrayPattern = ast.NodeOfType<ES2020, "ArrayPattern">;
/**
 * The node type for the ESTree `ArrowFunctionExpression` node.
 */
export declare type ArrowFunctionExpression = ast.NodeOfType<ES2020, "ArrowFunctionExpression">;
/**
 * The node type for the ESTree `AssignmentExpression` node.
 */
export declare type AssignmentExpression = ast.NodeOfType<ES2020, "AssignmentExpression">;
/**
 * The node type for the ESTree `AssignmentPattern` node.
 */
export declare type AssignmentPattern = ast.NodeOfType<ES2020, "AssignmentPattern">;
/**
 * The node type for the ESTree `AwaitExpression` node.
 */
export declare type AwaitExpression = ast.NodeOfType<ES2020, "AwaitExpression">;
/**
 * The node type for the ESTree `BinaryExpression` node.
 */
export declare type BinaryExpression = ast.NodeOfType<ES2020, "BinaryExpression">;
/**
 * The node type for the ESTree `BlockStatement` node.
 */
export declare type BlockStatement = ast.NodeOfType<ES2020, "BlockStatement">;
/**
 * The node type for the ESTree `BreakStatement` node.
 */
export declare type BreakStatement = ast.NodeOfType<ES2020, "BreakStatement">;
/**
 * The node type for the ESTree `CallExpression` node.
 */
export declare type CallExpression = ast.NodeOfType<ES2020, "CallExpression">;
/**
 * The node type for the ESTree `CatchClause` node.
 */
export declare type CatchClause = ast.NodeOfType<ES2020, "CatchClause">;
/**
 * The node type for the ESTree `ClassBody` node.
 */
export declare type ClassBody = ast.NodeOfType<ES2020, "ClassBody">;
/**
 * The node type for the ESTree `ClassDeclaration` node.
 */
export declare type ClassDeclaration = ast.NodeOfType<ES2020, "ClassDeclaration">;
/**
 * The node type for the ESTree `ClassExpression` node.
 */
export declare type ClassExpression = ast.NodeOfType<ES2020, "ClassExpression">;
/**
 * The node type for the ESTree `ConditionalExpression` node.
 */
export declare type ConditionalExpression = ast.NodeOfType<ES2020, "ConditionalExpression">;
/**
 * The node type for the ESTree `ContinueStatement` node.
 */
export declare type ContinueStatement = ast.NodeOfType<ES2020, "ContinueStatement">;
/**
 * The node type for the ESTree `DebuggerStatement` node.
 */
export declare type DebuggerStatement = ast.NodeOfType<ES2020, "DebuggerStatement">;
/**
 * The node type for the ESTree `DoWhileStatement` node.
 */
export declare type DoWhileStatement = ast.NodeOfType<ES2020, "DoWhileStatement">;
/**
 * The node type for the ESTree `EmptyStatement` node.
 */
export declare type EmptyStatement = ast.NodeOfType<ES2020, "EmptyStatement">;
/**
 * The node type for the ESTree `ExportAllDeclaration` node.
 */
export declare type ExportAllDeclaration = ast.NodeOfType<ES2020, "ExportAllDeclaration">;
/**
 * The node type for the ESTree `ExportDefaultDeclaration` node.
 */
export declare type ExportDefaultDeclaration = ast.NodeOfType<ES2020, "ExportDefaultDeclaration">;
/**
 * The node type for the ESTree `ExportNamedDeclaration` node.
 */
export declare type ExportNamedDeclaration = ast.NodeOfType<ES2020, "ExportNamedDeclaration">;
/**
 * The node type for the ESTree `ExportSpecifier` node.
 */
export declare type ExportSpecifier = ast.NodeOfType<ES2020, "ExportSpecifier">;
/**
 * The node type for the ESTree `ExpressionStatement` node.
 */
export declare type ExpressionStatement = ast.NodeOfType<ES2020, "ExpressionStatement">;
/**
 * The node type for the ESTree `ForInStatement` node.
 */
export declare type ForInStatement = ast.NodeOfType<ES2020, "ForInStatement">;
/**
 * The node type for the ESTree `ForOfStatement` node.
 */
export declare type ForOfStatement = ast.NodeOfType<ES2020, "ForOfStatement">;
/**
 * The node type for the ESTree `ForStatement` node.
 */
export declare type ForStatement = ast.NodeOfType<ES2020, "ForStatement">;
/**
 * The node type for the ESTree `FunctionDeclaration` node.
 */
export declare type FunctionDeclaration = ast.NodeOfType<ES2020, "FunctionDeclaration">;
/**
 * The node type for the ESTree `FunctionExpression` node.
 */
export declare type FunctionExpression = ast.NodeOfType<ES2020, "FunctionExpression">;
/**
 * The node type for the ESTree `Identifier` node.
 */
export declare type Identifier = ast.NodeOfType<ES2020, "Identifier">;
/**
 * The node type for the ESTree `IfStatement` node.
 */
export declare type IfStatement = ast.NodeOfType<ES2020, "IfStatement">;
/**
 * The node type for the ESTree `ImportDeclaration` node.
 */
export declare type ImportDeclaration = ast.NodeOfType<ES2020, "ImportDeclaration">;
/**
 * The node type for the ESTree `ImportDefaultSpecifier` node.
 */
export declare type ImportDefaultSpecifier = ast.NodeOfType<ES2020, "ImportDefaultSpecifier">;
/**
 * The node type for the ESTree `ImportExpression` node.
 */
export declare type ImportExpression = ast.NodeOfType<ES2020, "ImportExpression">;
/**
 * The node type for the ESTree `ImportNamespaceSpecifier` node.
 */
export declare type ImportNamespaceSpecifier = ast.NodeOfType<ES2020, "ImportNamespaceSpecifier">;
/**
 * The node type for the ESTree `ImportSpecifier` node.
 */
export declare type ImportSpecifier = ast.NodeOfType<ES2020, "ImportSpecifier">;
/**
 * The node type for the ESTree `LabeledStatement` node.
 */
export declare type LabeledStatement = ast.NodeOfType<ES2020, "LabeledStatement">;
/**
 * The node type for the ESTree `Literal` node.
 */
export declare type Literal = ast.NodeOfType<ES2020, "Literal">;
/**
 * The node type for the ESTree `LogicalExpression` node.
 */
export declare type LogicalExpression = ast.NodeOfType<ES2020, "LogicalExpression">;
/**
 * The node type for the ESTree `MemberExpression` node.
 */
export declare type MemberExpression = ast.NodeOfType<ES2020, "MemberExpression">;
/**
 * The node type for the ESTree `MetaProperty` node.
 */
export declare type MetaProperty = ast.NodeOfType<ES2020, "MetaProperty">;
/**
 * The node type for the ESTree `MethodDefinition` node.
 */
export declare type MethodDefinition = ast.NodeOfType<ES2020, "MethodDefinition">;
/**
 * The node type for the ESTree `NewExpression` node.
 */
export declare type NewExpression = ast.NodeOfType<ES2020, "NewExpression">;
/**
 * The node type for the ESTree `ObjectExpression` node.
 */
export declare type ObjectExpression = ast.NodeOfType<ES2020, "ObjectExpression">;
/**
 * The node type for the ESTree `ObjectPattern` node.
 */
export declare type ObjectPattern = ast.NodeOfType<ES2020, "ObjectPattern">;
/**
 * The node type for the ESTree `Program` node.
 */
export declare type Program = ast.NodeOfType<ES2020, "Program">;
/**
 * The node type for the ESTree `Property` node.
 */
export declare type Property = ast.NodeOfType<ES2020, "Property">;
/**
 * The node type for the ESTree `RestElement` node.
 */
export declare type RestElement = ast.NodeOfType<ES2020, "RestElement">;
/**
 * The node type for the ESTree `ReturnStatement` node.
 */
export declare type ReturnStatement = ast.NodeOfType<ES2020, "ReturnStatement">;
/**
 * The node type for the ESTree `SequenceExpression` node.
 */
export declare type SequenceExpression = ast.NodeOfType<ES2020, "SequenceExpression">;
/**
 * The node type for the ESTree `SpreadElement` node.
 */
export declare type SpreadElement = ast.NodeOfType<ES2020, "SpreadElement">;
/**
 * The node type for the ESTree `Super` node.
 */
export declare type Super = ast.NodeOfType<ES2020, "Super">;
/**
 * The node type for the ESTree `SwitchCase` node.
 */
export declare type SwitchCase = ast.NodeOfType<ES2020, "SwitchCase">;
/**
 * The node type for the ESTree `SwitchStatement` node.
 */
export declare type SwitchStatement = ast.NodeOfType<ES2020, "SwitchStatement">;
/**
 * The node type for the ESTree `TaggedTemplateExpression` node.
 */
export declare type TaggedTemplateExpression = ast.NodeOfType<ES2020, "TaggedTemplateExpression">;
/**
 * The node type for the ESTree `TemplateElement` node.
 */
export declare type TemplateElement = ast.NodeOfType<ES2020, "TemplateElement">;
/**
 * The node type for the ESTree `TemplateLiteral` node.
 */
export declare type TemplateLiteral = ast.NodeOfType<ES2020, "TemplateLiteral">;
/**
 * The node type for the ESTree `ThisExpression` node.
 */
export declare type ThisExpression = ast.NodeOfType<ES2020, "ThisExpression">;
/**
 * The node type for the ESTree `ThrowStatement` node.
 */
export declare type ThrowStatement = ast.NodeOfType<ES2020, "ThrowStatement">;
/**
 * The node type for the ESTree `TryStatement` node.
 */
export declare type TryStatement = ast.NodeOfType<ES2020, "TryStatement">;
/**
 * The node type for the ESTree `UnaryExpression` node.
 */
export declare type UnaryExpression = ast.NodeOfType<ES2020, "UnaryExpression">;
/**
 * The node type for the ESTree `UpdateExpression` node.
 */
export declare type UpdateExpression = ast.NodeOfType<ES2020, "UpdateExpression">;
/**
 * The node type for the ESTree `VariableDeclaration` node.
 */
export declare type VariableDeclaration = ast.NodeOfType<ES2020, "VariableDeclaration">;
/**
 * The node type for the ESTree `VariableDeclarator` node.
 */
export declare type VariableDeclarator = ast.NodeOfType<ES2020, "VariableDeclarator">;
/**
 * The node type for the ESTree `WhileStatement` node.
 */
export declare type WhileStatement = ast.NodeOfType<ES2020, "WhileStatement">;
/**
 * The node type for the ESTree `WithStatement` node.
 */
export declare type WithStatement = ast.NodeOfType<ES2020, "WithStatement">;
/**
 * The node type for the ESTree `YieldExpression` node.
 */
export declare type YieldExpression = ast.NodeOfType<ES2020, "YieldExpression">;
