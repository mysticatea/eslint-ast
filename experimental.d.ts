/**
 * @fileoverview The AST types for Experimental.
 */
import * as ast from "./lib/ast";
import { Comment, Definition as Experimental, IndexRange, LineColumnRange, LineColumn, Token } from "./experimental-definition";
export { Comment, IndexRange, LineColumnRange, LineColumn, Token };
/** The map-like object that has all nodes and aliases. */
export declare type AST = ast.AST<Experimental>;
...
export declare namespace AST {
    ...
    type PropertyDefinition = AST["PropertyDefinition"];
    ...
    type AssignmentPlainProperty = AST["AssignmentPlainProperty"];
    ...
    type AssignmentRestProperty = AST["AssignmentRestProperty"];
    ...
    /** The type for the `BigIntLiteral` node. */
    ...
    type BindingPlainProperty = AST["BindingPlainProperty"];
    ...
    type BindingRestProperty = AST["BindingRestProperty"];
    ...
    /** The type for the `ChainExpression` node. */
    type ChainExpression = AST["ChainExpression"];
    ...
    /** The type for the `CoalesceExpression` node. */
    type CoalesceExpression = AST["CoalesceExpression"];
    ...
    type ComputedPropertyDefinition = AST["ComputedPropertyDefinition"];
    ...
    /** The type for the `ImportAttribute` node. */
    ...
    /** The type for the `ImportExpression` node. */
    ...
    type LogicalAssignmentExpression = AST["LogicalAssignmentExpression"];
    ...
    type PlainClassDeclaration = AST["PlainClassDeclaration"];
    ...
    type PrivateMemberExpression = AST["PrivateMemberExpression"];
    /** The type for the `PrivateMethodDefinition` node. */
    type PrivateMethodDefinition = AST["PrivateMethodDefinition"];
    /** The type for the `PrivatePropertyDefinition` node. */
    type PrivatePropertyDefinition = AST["PrivatePropertyDefinition"];
    ...
    /** The type for the `StaticBlock` node. */
    type StaticBlock = AST["StaticBlock"];
...
export declare type AliasName = ast.AliasName<Experimental>;
/**
 ...
 */
export declare type NodeName = ast.NodeName<Experimental>;
/**
 ...
 */
export declare type TypeName = ast.ASTType<Experimental>;
/** The union type for all nodes. */
...
/** The union type for the `PropertyDefinition` alias. */
export declare type PropertyDefinition = AST["PropertyDefinition"];
/** The union type for the `RestElement` alias. */
...
/** The type for the `AssignmentPlainProperty` node. */
export declare type AssignmentPlainProperty = AST["AssignmentPlainProperty"];
/** The type for the `AssignmentRestElement` node. */
export declare type AssignmentRestElement = AST["AssignmentRestElement"];
/** The type for the `AssignmentRestProperty` node. */
export declare type AssignmentRestProperty = AST["AssignmentRestProperty"];
/** The type for the `AssignmentShorthandProperty` node. */
...
/** The type for the `BigIntLiteral` node. */
export declare type BigIntLiteral = AST["BigIntLiteral"];
/** The type for the `BinaryExpression` node. */
...
/** The type for the `BindingPlainProperty` node. */
export declare type BindingPlainProperty = AST["BindingPlainProperty"];
/** The type for the `BindingRestElement` node. */
export declare type BindingRestElement = AST["BindingRestElement"];
/** The type for the `BindingRestProperty` node. */
export declare type BindingRestProperty = AST["BindingRestProperty"];
/** The type for the `BindingShorthandProperty` node. */
...
/** The type for the `ChainExpression` node. */
export declare type ChainExpression = AST["ChainExpression"];
/** The type for the `ClassBody` node. */
export declare type ClassBody = AST["ClassBody"];
/** The type for the `ClassExpression` node. */
export declare type ClassExpression = AST["ClassExpression"];
/** The type for the `CoalesceExpression` node. */
export declare type CoalesceExpression = AST["CoalesceExpression"];
/** The type for the `CompoundAssignmentExpression` node. */
...
/** The type for the `ComputedPropertyDefinition` node. */
export declare type ComputedPropertyDefinition = AST["ComputedPropertyDefinition"];
/** The type for the `ConditionalExpression` node. */
...
/** The type for the `ImportAttribute` node. */
export declare type ImportAttribute = AST["ImportAttribute"];
/** The type for the `ImportDeclaration` node. */
...
/** The type for the `ImportExpression` node. */
export declare type ImportExpression = AST["ImportExpression"];
/** The type for the `ImportNamespaceSpecifier` node. */
...
/** The type for the `LogicalAssignmentExpression` node. */
export declare type LogicalAssignmentExpression = AST["LogicalAssignmentExpression"];
/** The type for the `MetaProperty` node. */
...
/** The type for the `PlainClassDeclaration` node. */
export declare type PlainClassDeclaration = AST["PlainClassDeclaration"];
/** The type for the `PlainFunctionDeclaration` node. */
...
/** The type for the `PlainMethodDefinition` node. */
export declare type PlainMethodDefinition = AST["PlainMethodDefinition"];
/** The type for the `PlainProperty` node. */
export declare type PlainProperty = AST["PlainProperty"];
/** The type for the `PlainPropertyDefinition` node. */
export declare type PlainPropertyDefinition = AST["PlainPropertyDefinition"];
/** The type for the `PrivateIdentifier` node. */
export declare type PrivateIdentifier = AST["PrivateIdentifier"];
/** The type for the `PrivateMemberExpression` node. */
export declare type PrivateMemberExpression = AST["PrivateMemberExpression"];
/** The type for the `PrivateMethodDefinition` node. */
export declare type PrivateMethodDefinition = AST["PrivateMethodDefinition"];
/** The type for the `PrivatePropertyDefinition` node. */
export declare type PrivatePropertyDefinition = AST["PrivatePropertyDefinition"];
/** The type for the `RegExpLiteral` node. */
...
/** The type for the `StaticBlock` node. */
export declare type StaticBlock = AST["StaticBlock"];
/** The type for the `StringLiteral` node. */
