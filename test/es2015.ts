import { AST, Comment, IndexRange, LineColumnRange, Token } from "../es2015"
...
assert<
    EqualsObject<
        AST.BindingObjectPattern,
        {
            ...
            readonly properties: readonly AST.BindingProperty[]
        }
    >
>()
assert<
...
assert<
    EqualsObject<
        AST.AssignmentObjectPattern,
        {
            ...
            readonly loc: LineColumnRange
            readonly type: "ObjectPattern"
            readonly properties: readonly AST.AssignmentProperty[]
        }
    >
>()
assert<
...
assert<
    EqualsObject<
        AST.TaggedTemplateExpression,
        {
            ...
            readonly tag: AST.Expression
            readonly quasi: AST.TemplateLiteral
        }
    >
>()
