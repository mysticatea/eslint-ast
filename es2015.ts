 ...
 */
export type AST = ast.AST<ES2015>
 ...
 */
export type AliasName = ast.AliasName<ES2015>
 ...
 */
export type NodeName = ast.NodeName<ES2015>
 ...
 */
export type TypeName = ast.ASTType<ES2015>
 ...
 */
export type ArrayExpression = ast.NodeOfType<ES2015, "ArrayExpression">

/**
 * The node type for the ESTree `ArrayPattern` node.
 */
export type ArrayPattern = ast.NodeOfType<ES2015, "ArrayPattern">
 ...
 */
export type AssignmentPattern = ast.NodeOfType<ES2015, "AssignmentPattern">

/**
 * The node type for the ESTree `BinaryExpression` node.
 */
export type BinaryExpression = ast.NodeOfType<ES2015, "BinaryExpression">

/**
 * The node type for the ESTree `BlockStatement` node.
 */
export type BlockStatement = ast.NodeOfType<ES2015, "BlockStatement">

/**
 * The node type for the ESTree `BreakStatement` node.
 */
export type BreakStatement = ast.NodeOfType<ES2015, "BreakStatement">

/**
 * The node type for the ESTree `CallExpression` node.
 */
export type CallExpression = ast.NodeOfType<ES2015, "CallExpression">

/**
 * The node type for the ESTree `CatchClause` node.
 */
export type CatchClause = ast.NodeOfType<ES2015, "CatchClause">

/**
 * The node type for the ESTree `ClassBody` node.
 */
export type ClassBody = ast.NodeOfType<ES2015, "ClassBody">

/**
 * The node type for the ESTree `ClassDeclaration` node.
 */
export type ClassDeclaration = ast.NodeOfType<ES2015, "ClassDeclaration">

/**
 * The node type for the ESTree `ClassExpression` node.
 */
export type ClassExpression = ast.NodeOfType<ES2015, "ClassExpression">
 ...
 */
export type ContinueStatement = ast.NodeOfType<ES2015, "ContinueStatement">

/**
 * The node type for the ESTree `DebuggerStatement` node.
 */
export type DebuggerStatement = ast.NodeOfType<ES2015, "DebuggerStatement">

/**
 * The node type for the ESTree `DoWhileStatement` node.
 */
export type DoWhileStatement = ast.NodeOfType<ES2015, "DoWhileStatement">

/**
 * The node type for the ESTree `EmptyStatement` node.
 */
export type EmptyStatement = ast.NodeOfType<ES2015, "EmptyStatement">
 ...
 */
export type ExportSpecifier = ast.NodeOfType<ES2015, "ExportSpecifier">

/**
 * The node type for the ESTree `ExpressionStatement` node.
 */
export type ExpressionStatement = ast.NodeOfType<ES2015, "ExpressionStatement">

/**
 * The node type for the ESTree `ForInStatement` node.
 */
export type ForInStatement = ast.NodeOfType<ES2015, "ForInStatement">

/**
 * The node type for the ESTree `ForOfStatement` node.
 */
export type ForOfStatement = ast.NodeOfType<ES2015, "ForOfStatement">

/**
 * The node type for the ESTree `ForStatement` node.
 */
export type ForStatement = ast.NodeOfType<ES2015, "ForStatement">

/**
 * The node type for the ESTree `FunctionDeclaration` node.
 */
export type FunctionDeclaration = ast.NodeOfType<ES2015, "FunctionDeclaration">

/**
 * The node type for the ESTree `FunctionExpression` node.
 */
export type FunctionExpression = ast.NodeOfType<ES2015, "FunctionExpression">

/**
 * The node type for the ESTree `Identifier` node.
 */
export type Identifier = ast.NodeOfType<ES2015, "Identifier">

/**
 * The node type for the ESTree `IfStatement` node.
 */
export type IfStatement = ast.NodeOfType<ES2015, "IfStatement">

/**
 * The node type for the ESTree `ImportDeclaration` node.
 */
export type ImportDeclaration = ast.NodeOfType<ES2015, "ImportDeclaration">
 ...
 */
export type ImportSpecifier = ast.NodeOfType<ES2015, "ImportSpecifier">

/**
 * The node type for the ESTree `LabeledStatement` node.
 */
export type LabeledStatement = ast.NodeOfType<ES2015, "LabeledStatement">

/**
 * The node type for the ESTree `Literal` node.
 */
export type Literal = ast.NodeOfType<ES2015, "Literal">

/**
 * The node type for the ESTree `LogicalExpression` node.
 */
export type LogicalExpression = ast.NodeOfType<ES2015, "LogicalExpression">

/**
 * The node type for the ESTree `MemberExpression` node.
 */
export type MemberExpression = ast.NodeOfType<ES2015, "MemberExpression">

/**
 * The node type for the ESTree `MetaProperty` node.
 */
export type MetaProperty = ast.NodeOfType<ES2015, "MetaProperty">

/**
 * The node type for the ESTree `MethodDefinition` node.
 */
export type MethodDefinition = ast.NodeOfType<ES2015, "MethodDefinition">

/**
 * The node type for the ESTree `NewExpression` node.
 */
export type NewExpression = ast.NodeOfType<ES2015, "NewExpression">

/**
 * The node type for the ESTree `ObjectExpression` node.
 */
export type ObjectExpression = ast.NodeOfType<ES2015, "ObjectExpression">

/**
 * The node type for the ESTree `ObjectPattern` node.
 */
export type ObjectPattern = ast.NodeOfType<ES2015, "ObjectPattern">

/**
 * The node type for the ESTree `Program` node.
 */
export type Program = ast.NodeOfType<ES2015, "Program">

/**
 * The node type for the ESTree `Property` node.
 */
export type Property = ast.NodeOfType<ES2015, "Property">

/**
 * The node type for the ESTree `RestElement` node.
 */
export type RestElement = ast.NodeOfType<ES2015, "RestElement">

/**
 * The node type for the ESTree `ReturnStatement` node.
 */
export type ReturnStatement = ast.NodeOfType<ES2015, "ReturnStatement">

/**
 * The node type for the ESTree `SequenceExpression` node.
 */
export type SequenceExpression = ast.NodeOfType<ES2015, "SequenceExpression">

/**
 * The node type for the ESTree `SpreadElement` node.
 */
export type SpreadElement = ast.NodeOfType<ES2015, "SpreadElement">

/**
 * The node type for the ESTree `Super` node.
 */
export type Super = ast.NodeOfType<ES2015, "Super">

/**
 * The node type for the ESTree `SwitchCase` node.
 */
export type SwitchCase = ast.NodeOfType<ES2015, "SwitchCase">

/**
 * The node type for the ESTree `SwitchStatement` node.
 */
export type SwitchStatement = ast.NodeOfType<ES2015, "SwitchStatement">
 ...
 */
export type TemplateElement = ast.NodeOfType<ES2015, "TemplateElement">

/**
 * The node type for the ESTree `TemplateLiteral` node.
 */
export type TemplateLiteral = ast.NodeOfType<ES2015, "TemplateLiteral">

/**
 * The node type for the ESTree `ThisExpression` node.
 */
export type ThisExpression = ast.NodeOfType<ES2015, "ThisExpression">

/**
 * The node type for the ESTree `ThrowStatement` node.
 */
export type ThrowStatement = ast.NodeOfType<ES2015, "ThrowStatement">

/**
 * The node type for the ESTree `TryStatement` node.
 */
export type TryStatement = ast.NodeOfType<ES2015, "TryStatement">

/**
 * The node type for the ESTree `UnaryExpression` node.
 */
export type UnaryExpression = ast.NodeOfType<ES2015, "UnaryExpression">

/**
 * The node type for the ESTree `UpdateExpression` node.
 */
export type UpdateExpression = ast.NodeOfType<ES2015, "UpdateExpression">

/**
 * The node type for the ESTree `VariableDeclaration` node.
 */
export type VariableDeclaration = ast.NodeOfType<ES2015, "VariableDeclaration">

/**
 * The node type for the ESTree `VariableDeclarator` node.
 */
export type VariableDeclarator = ast.NodeOfType<ES2015, "VariableDeclarator">

/**
 * The node type for the ESTree `WhileStatement` node.
 */
export type WhileStatement = ast.NodeOfType<ES2015, "WhileStatement">

/**
 * The node type for the ESTree `WithStatement` node.
 */
export type WithStatement = ast.NodeOfType<ES2015, "WithStatement">

/**
 * The node type for the ESTree `YieldExpression` node.
 */
export type YieldExpression = ast.NodeOfType<ES2015, "YieldExpression">
