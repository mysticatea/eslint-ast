...
export interface Enhancement {
    nodes: {
        ...
        ExportDefaultDeclaration: {
            declaration: NodeRef<"AnonymousDefaultExportedClassDeclaration"> | NodeRef<"AnonymousDefaultExportedFunctionDeclaration"> | NodeRef<"PlainClassDeclaration"> | NodeRef<"PlainFunctionDeclaration"> | NodeRef<"Expression">;
        };
        ExportNamedDeclDeclaration: {
            type: "ExportNamedDeclaration";
            declaration: NodeRef<"PlainClassDeclaration"> | NodeRef<"PlainFunctionDeclaration"> | NodeRef<"VariableDeclaration">;
            specifiers: [];
            source: null;
        };
    ...
    aliases: {
        ...
        Expression: "ArrowFunctionExpression" | "ClassExpression" | "MetaProperty" | "TaggedTemplateExpression" | "TemplateLiteral" | "YieldExpression";
        ...
        AssignmentProperty: "AssignmentComputedProperty" | "AssignmentPlainProperty" | "AssignmentShorthandProperty";
        BindingProperty: "BindingComputedProperty" | "BindingPlainProperty" | "BindingShorthandProperty";
