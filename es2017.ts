 ...
 */
export type AST = ast.AST<ES2017>
 ...
 */
export type AliasName = ast.AliasName<ES2017>
 ...
 */
export type NodeName = ast.NodeName<ES2017>
 ...
 */
export type TypeName = ast.ASTType<ES2017>
 ...
 */
export type ArrayExpression = ast.NodeOfType<ES2017, "ArrayExpression">

/**
 * The node type for the ESTree `ArrayPattern` node.
 */
export type ArrayPattern = ast.NodeOfType<ES2017, "ArrayPattern">
 ...
 */
export type AssignmentPattern = ast.NodeOfType<ES2017, "AssignmentPattern">

/**
 * The node type for the ESTree `AwaitExpression` node.
 */
export type AwaitExpression = ast.NodeOfType<ES2017, "AwaitExpression">

/**
 * The node type for the ESTree `BinaryExpression` node.
 */
export type BinaryExpression = ast.NodeOfType<ES2017, "BinaryExpression">

/**
 * The node type for the ESTree `BlockStatement` node.
 */
export type BlockStatement = ast.NodeOfType<ES2017, "BlockStatement">

/**
 * The node type for the ESTree `BreakStatement` node.
 */
export type BreakStatement = ast.NodeOfType<ES2017, "BreakStatement">

/**
 * The node type for the ESTree `CallExpression` node.
 */
export type CallExpression = ast.NodeOfType<ES2017, "CallExpression">

/**
 * The node type for the ESTree `CatchClause` node.
 */
export type CatchClause = ast.NodeOfType<ES2017, "CatchClause">

/**
 * The node type for the ESTree `ClassBody` node.
 */
export type ClassBody = ast.NodeOfType<ES2017, "ClassBody">

/**
 * The node type for the ESTree `ClassDeclaration` node.
 */
export type ClassDeclaration = ast.NodeOfType<ES2017, "ClassDeclaration">

/**
 * The node type for the ESTree `ClassExpression` node.
 */
export type ClassExpression = ast.NodeOfType<ES2017, "ClassExpression">
 ...
 */
export type ContinueStatement = ast.NodeOfType<ES2017, "ContinueStatement">

/**
 * The node type for the ESTree `DebuggerStatement` node.
 */
export type DebuggerStatement = ast.NodeOfType<ES2017, "DebuggerStatement">

/**
 * The node type for the ESTree `DoWhileStatement` node.
 */
export type DoWhileStatement = ast.NodeOfType<ES2017, "DoWhileStatement">

/**
 * The node type for the ESTree `EmptyStatement` node.
 */
export type EmptyStatement = ast.NodeOfType<ES2017, "EmptyStatement">
 ...
 */
export type ExportSpecifier = ast.NodeOfType<ES2017, "ExportSpecifier">

/**
 * The node type for the ESTree `ExpressionStatement` node.
 */
export type ExpressionStatement = ast.NodeOfType<ES2017, "ExpressionStatement">

/**
 * The node type for the ESTree `ForInStatement` node.
 */
export type ForInStatement = ast.NodeOfType<ES2017, "ForInStatement">

/**
 * The node type for the ESTree `ForOfStatement` node.
 */
export type ForOfStatement = ast.NodeOfType<ES2017, "ForOfStatement">

/**
 * The node type for the ESTree `ForStatement` node.
 */
export type ForStatement = ast.NodeOfType<ES2017, "ForStatement">

/**
 * The node type for the ESTree `FunctionDeclaration` node.
 */
export type FunctionDeclaration = ast.NodeOfType<ES2017, "FunctionDeclaration">

/**
 * The node type for the ESTree `FunctionExpression` node.
 */
export type FunctionExpression = ast.NodeOfType<ES2017, "FunctionExpression">

/**
 * The node type for the ESTree `Identifier` node.
 */
export type Identifier = ast.NodeOfType<ES2017, "Identifier">

/**
 * The node type for the ESTree `IfStatement` node.
 */
export type IfStatement = ast.NodeOfType<ES2017, "IfStatement">

/**
 * The node type for the ESTree `ImportDeclaration` node.
 */
export type ImportDeclaration = ast.NodeOfType<ES2017, "ImportDeclaration">
 ...
 */
export type ImportSpecifier = ast.NodeOfType<ES2017, "ImportSpecifier">

/**
 * The node type for the ESTree `LabeledStatement` node.
 */
export type LabeledStatement = ast.NodeOfType<ES2017, "LabeledStatement">

/**
 * The node type for the ESTree `Literal` node.
 */
export type Literal = ast.NodeOfType<ES2017, "Literal">

/**
 * The node type for the ESTree `LogicalExpression` node.
 */
export type LogicalExpression = ast.NodeOfType<ES2017, "LogicalExpression">

/**
 * The node type for the ESTree `MemberExpression` node.
 */
export type MemberExpression = ast.NodeOfType<ES2017, "MemberExpression">

/**
 * The node type for the ESTree `MetaProperty` node.
 */
export type MetaProperty = ast.NodeOfType<ES2017, "MetaProperty">

/**
 * The node type for the ESTree `MethodDefinition` node.
 */
export type MethodDefinition = ast.NodeOfType<ES2017, "MethodDefinition">

/**
 * The node type for the ESTree `NewExpression` node.
 */
export type NewExpression = ast.NodeOfType<ES2017, "NewExpression">

/**
 * The node type for the ESTree `ObjectExpression` node.
 */
export type ObjectExpression = ast.NodeOfType<ES2017, "ObjectExpression">

/**
 * The node type for the ESTree `ObjectPattern` node.
 */
export type ObjectPattern = ast.NodeOfType<ES2017, "ObjectPattern">

/**
 * The node type for the ESTree `Program` node.
 */
export type Program = ast.NodeOfType<ES2017, "Program">

/**
 * The node type for the ESTree `Property` node.
 */
export type Property = ast.NodeOfType<ES2017, "Property">

/**
 * The node type for the ESTree `RestElement` node.
 */
export type RestElement = ast.NodeOfType<ES2017, "RestElement">

/**
 * The node type for the ESTree `ReturnStatement` node.
 */
export type ReturnStatement = ast.NodeOfType<ES2017, "ReturnStatement">

/**
 * The node type for the ESTree `SequenceExpression` node.
 */
export type SequenceExpression = ast.NodeOfType<ES2017, "SequenceExpression">

/**
 * The node type for the ESTree `SpreadElement` node.
 */
export type SpreadElement = ast.NodeOfType<ES2017, "SpreadElement">

/**
 * The node type for the ESTree `Super` node.
 */
export type Super = ast.NodeOfType<ES2017, "Super">

/**
 * The node type for the ESTree `SwitchCase` node.
 */
export type SwitchCase = ast.NodeOfType<ES2017, "SwitchCase">

/**
 * The node type for the ESTree `SwitchStatement` node.
 */
export type SwitchStatement = ast.NodeOfType<ES2017, "SwitchStatement">
 ...
 */
export type TemplateElement = ast.NodeOfType<ES2017, "TemplateElement">

/**
 * The node type for the ESTree `TemplateLiteral` node.
 */
export type TemplateLiteral = ast.NodeOfType<ES2017, "TemplateLiteral">

/**
 * The node type for the ESTree `ThisExpression` node.
 */
export type ThisExpression = ast.NodeOfType<ES2017, "ThisExpression">

/**
 * The node type for the ESTree `ThrowStatement` node.
 */
export type ThrowStatement = ast.NodeOfType<ES2017, "ThrowStatement">

/**
 * The node type for the ESTree `TryStatement` node.
 */
export type TryStatement = ast.NodeOfType<ES2017, "TryStatement">

/**
 * The node type for the ESTree `UnaryExpression` node.
 */
export type UnaryExpression = ast.NodeOfType<ES2017, "UnaryExpression">

/**
 * The node type for the ESTree `UpdateExpression` node.
 */
export type UpdateExpression = ast.NodeOfType<ES2017, "UpdateExpression">

/**
 * The node type for the ESTree `VariableDeclaration` node.
 */
export type VariableDeclaration = ast.NodeOfType<ES2017, "VariableDeclaration">

/**
 * The node type for the ESTree `VariableDeclarator` node.
 */
export type VariableDeclarator = ast.NodeOfType<ES2017, "VariableDeclarator">

/**
 * The node type for the ESTree `WhileStatement` node.
 */
export type WhileStatement = ast.NodeOfType<ES2017, "WhileStatement">

/**
 * The node type for the ESTree `WithStatement` node.
 */
export type WithStatement = ast.NodeOfType<ES2017, "WithStatement">

/**
 * The node type for the ESTree `YieldExpression` node.
 */
export type YieldExpression = ast.NodeOfType<ES2017, "YieldExpression">
