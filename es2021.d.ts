/**
 * @fileoverview The AST types for ES2021.
 */
import * as ast from "./lib/ast";
import { Comment, Definition as ES2021, IndexRange, LineColumnRange, LineColumn, Token } from "./es2021-definition";
export { Comment, IndexRange, LineColumnRange, LineColumn, Token };
/** The map-like object that has all nodes and aliases. */
export declare type AST = ast.AST<ES2021>;
...
export declare type AliasName = ast.AliasName<ES2021>;
/**
 ...
 */
export declare type NodeName = ast.NodeName<ES2021>;
/**
 ...
 */
export declare type TypeName = ast.ASTType<ES2021>;
/** The union type for all nodes. */
