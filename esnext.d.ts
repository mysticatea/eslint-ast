/**
 * @fileoverview The AST types for ESNext.
 */
...
export declare type AST = ast.AST<ESNext>;
...
export declare type AliasName = ast.AliasName<ESNext>;
/**
 ...
 */
export declare type NodeName = ast.NodeName<ESNext>;
/**
 ...
 */
export declare type TypeName = ast.ASTType<ESNext>;
/** The union type for all nodes. */
