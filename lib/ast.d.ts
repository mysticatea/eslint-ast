import { ASTType, AliasName, Definition, NodeName, NodeNameOfAlias } from "./definition";
...
export declare type AST<D extends Definition> = {
    [N in NodeName<D> | AliasName<D> | "Node"]: N extends "Node" ? NodeOfNodeName<D, NodeName<D>> : N extends AliasName<D> ? NodeOfNodeName<D, NodeNameOfAlias<D, N>> : Node<D, N>;
};
/**
 ...
 */
export declare type NodeOfType<D extends Definition, T extends ASTType<D>> = Extract<AST<D>["Node"], {
    type: T;
}>;
