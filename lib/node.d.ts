 ...
 */
declare type NodePropertyNames<D extends Definition, N extends NodeName<D>> = "parent" | "type" | CommonPropertyName<D> | keyof D["nodes"][N];
/**
 ...
 */
declare type ResolveNodeRef_<D extends Definition, V> = V extends {
    $ref: infer N;
} ? N extends "Node" ? ResolveNodeRefNodeString<D> : N extends AliasName<D> ? ResolveNodeRefAliasName<D, N> : N extends NodeName<D> ? Node<D, N> : N extends ASTType<D> ? NodeOfNodeName<D, NodeNameOfASTType<D, N>> : {
    "!! UNKNOWN NODE NAME !!": N;
 ...
 * @template V The value that may be `NodeRef<T>`
 */
declare type NameOfNodeRef_<D extends Definition, V> = V extends {
    $ref: infer N;
} ? N extends "Node" ? NodeName<D> : N extends AliasName<D> ? NodeNameOfAliasName<D, N> : N extends NodeName<D> ? N : N extends ASTType<D> ? NodeNameOfASTType<D, N> : never : never;
/**
 ...
 * @template V The value that may be `NodeRef<T>`
 */
declare type NameOfNodeRef<D extends Definition, V> = V extends readonly (infer E)[] ? NameOfNodeRef_<D, E> : NameOfNodeRef_<D, V>;
/**
