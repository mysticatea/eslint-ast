 ...
 * @template D The AST definition.
 */
export declare type CommonPropertyName<D extends Definition> = keyof D["commonProperties"] & string;
/**
 ...
 */
export declare type NodeNameOfAliasName<D extends Definition, N extends AliasName<D> | "Node"> = N extends "Node" ? NodeName<D> : Extract<NodeName<D>, D["aliases"] extends infer A ? A extends Record<N, string> ? A[N] : never : never>;
/**
 * The actual node names of AST type names.
 * @template D The AST definition.
 * @template T An alias name.
 */
export declare type NodeNameOfASTType<D extends Definition, T extends ASTType<D>> = {
 ...
 */
export declare type ASTTypeOfNodeName<D extends Definition, N extends NodeName<D>> = D["nodes"][N] extends {
    type: infer T;
