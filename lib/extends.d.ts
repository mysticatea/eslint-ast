 ...
 */
declare type Prop<TObject, TKey extends keyof any, TExpected, TDefault> = [
    TObject
] extends [{
 ...
 */
declare type MergeNodeDef<D, E> = {
    [P in ExtractStringLiteral<keyof (D & E)>]: UniteArray<Prop<D, P, any, never> | Prop<E, P, any, never>>;
};
/**
 ...
 * @template E The value of enhancement.
 */
declare type MergeNodes<D, E> = {
    [P in ExtractStringLiteral<keyof (D & E)>]: MergeNodeDef<Prop<D, P, {}, {}>, Prop<E, P, {}, {}>>;
};
/**
 ...
 * @template E The value of enhancement.
 */
declare type MergeAliases<D, E> = {
    [P in ExtractStringLiteral<keyof (D & E)>]: ExtractStringLiteral<Prop<D, P, string, never> | Prop<E, P, string, never>>;
};
/**
 ...
 */
export declare type Extends<D extends Definition, E extends Definition> = {
