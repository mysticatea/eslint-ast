 ...
 */
export type AST = ast.AST<ES2019>
 ...
 */
export type AliasName = ast.AliasName<ES2019>
 ...
 */
export type NodeName = ast.NodeName<ES2019>
 ...
 */
export type TypeName = ast.ASTType<ES2019>
 ...
 */
export type ArrayExpression = ast.NodeOfType<ES2019, "ArrayExpression">

/**
 * The node type for the ESTree `ArrayPattern` node.
 */
export type ArrayPattern = ast.NodeOfType<ES2019, "ArrayPattern">
 ...
 */
export type AssignmentPattern = ast.NodeOfType<ES2019, "AssignmentPattern">

/**
 * The node type for the ESTree `AwaitExpression` node.
 */
export type AwaitExpression = ast.NodeOfType<ES2019, "AwaitExpression">

/**
 * The node type for the ESTree `BinaryExpression` node.
 */
export type BinaryExpression = ast.NodeOfType<ES2019, "BinaryExpression">

/**
 * The node type for the ESTree `BlockStatement` node.
 */
export type BlockStatement = ast.NodeOfType<ES2019, "BlockStatement">

/**
 * The node type for the ESTree `BreakStatement` node.
 */
export type BreakStatement = ast.NodeOfType<ES2019, "BreakStatement">

/**
 * The node type for the ESTree `CallExpression` node.
 */
export type CallExpression = ast.NodeOfType<ES2019, "CallExpression">

/**
 * The node type for the ESTree `CatchClause` node.
 */
export type CatchClause = ast.NodeOfType<ES2019, "CatchClause">

/**
 * The node type for the ESTree `ClassBody` node.
 */
export type ClassBody = ast.NodeOfType<ES2019, "ClassBody">

/**
 * The node type for the ESTree `ClassDeclaration` node.
 */
export type ClassDeclaration = ast.NodeOfType<ES2019, "ClassDeclaration">

/**
 * The node type for the ESTree `ClassExpression` node.
 */
export type ClassExpression = ast.NodeOfType<ES2019, "ClassExpression">
 ...
 */
export type ContinueStatement = ast.NodeOfType<ES2019, "ContinueStatement">

/**
 * The node type for the ESTree `DebuggerStatement` node.
 */
export type DebuggerStatement = ast.NodeOfType<ES2019, "DebuggerStatement">

/**
 * The node type for the ESTree `DoWhileStatement` node.
 */
export type DoWhileStatement = ast.NodeOfType<ES2019, "DoWhileStatement">

/**
 * The node type for the ESTree `EmptyStatement` node.
 */
export type EmptyStatement = ast.NodeOfType<ES2019, "EmptyStatement">
 ...
 */
export type ExportSpecifier = ast.NodeOfType<ES2019, "ExportSpecifier">

/**
 * The node type for the ESTree `ExpressionStatement` node.
 */
export type ExpressionStatement = ast.NodeOfType<ES2019, "ExpressionStatement">

/**
 * The node type for the ESTree `ForInStatement` node.
 */
export type ForInStatement = ast.NodeOfType<ES2019, "ForInStatement">

/**
 * The node type for the ESTree `ForOfStatement` node.
 */
export type ForOfStatement = ast.NodeOfType<ES2019, "ForOfStatement">

/**
 * The node type for the ESTree `ForStatement` node.
 */
export type ForStatement = ast.NodeOfType<ES2019, "ForStatement">

/**
 * The node type for the ESTree `FunctionDeclaration` node.
 */
export type FunctionDeclaration = ast.NodeOfType<ES2019, "FunctionDeclaration">

/**
 * The node type for the ESTree `FunctionExpression` node.
 */
export type FunctionExpression = ast.NodeOfType<ES2019, "FunctionExpression">

/**
 * The node type for the ESTree `Identifier` node.
 */
export type Identifier = ast.NodeOfType<ES2019, "Identifier">

/**
 * The node type for the ESTree `IfStatement` node.
 */
export type IfStatement = ast.NodeOfType<ES2019, "IfStatement">

/**
 * The node type for the ESTree `ImportDeclaration` node.
 */
export type ImportDeclaration = ast.NodeOfType<ES2019, "ImportDeclaration">
 ...
 */
export type ImportSpecifier = ast.NodeOfType<ES2019, "ImportSpecifier">

/**
 * The node type for the ESTree `LabeledStatement` node.
 */
export type LabeledStatement = ast.NodeOfType<ES2019, "LabeledStatement">

/**
 * The node type for the ESTree `Literal` node.
 */
export type Literal = ast.NodeOfType<ES2019, "Literal">

/**
 * The node type for the ESTree `LogicalExpression` node.
 */
export type LogicalExpression = ast.NodeOfType<ES2019, "LogicalExpression">

/**
 * The node type for the ESTree `MemberExpression` node.
 */
export type MemberExpression = ast.NodeOfType<ES2019, "MemberExpression">

/**
 * The node type for the ESTree `MetaProperty` node.
 */
export type MetaProperty = ast.NodeOfType<ES2019, "MetaProperty">

/**
 * The node type for the ESTree `MethodDefinition` node.
 */
export type MethodDefinition = ast.NodeOfType<ES2019, "MethodDefinition">

/**
 * The node type for the ESTree `NewExpression` node.
 */
export type NewExpression = ast.NodeOfType<ES2019, "NewExpression">

/**
 * The node type for the ESTree `ObjectExpression` node.
 */
export type ObjectExpression = ast.NodeOfType<ES2019, "ObjectExpression">

/**
 * The node type for the ESTree `ObjectPattern` node.
 */
export type ObjectPattern = ast.NodeOfType<ES2019, "ObjectPattern">

/**
 * The node type for the ESTree `Program` node.
 */
export type Program = ast.NodeOfType<ES2019, "Program">

/**
 * The node type for the ESTree `Property` node.
 */
export type Property = ast.NodeOfType<ES2019, "Property">

/**
 * The node type for the ESTree `RestElement` node.
 */
export type RestElement = ast.NodeOfType<ES2019, "RestElement">

/**
 * The node type for the ESTree `ReturnStatement` node.
 */
export type ReturnStatement = ast.NodeOfType<ES2019, "ReturnStatement">

/**
 * The node type for the ESTree `SequenceExpression` node.
 */
export type SequenceExpression = ast.NodeOfType<ES2019, "SequenceExpression">

/**
 * The node type for the ESTree `SpreadElement` node.
 */
export type SpreadElement = ast.NodeOfType<ES2019, "SpreadElement">

/**
 * The node type for the ESTree `Super` node.
 */
export type Super = ast.NodeOfType<ES2019, "Super">

/**
 * The node type for the ESTree `SwitchCase` node.
 */
export type SwitchCase = ast.NodeOfType<ES2019, "SwitchCase">

/**
 * The node type for the ESTree `SwitchStatement` node.
 */
export type SwitchStatement = ast.NodeOfType<ES2019, "SwitchStatement">
 ...
 */
export type TemplateElement = ast.NodeOfType<ES2019, "TemplateElement">

/**
 * The node type for the ESTree `TemplateLiteral` node.
 */
export type TemplateLiteral = ast.NodeOfType<ES2019, "TemplateLiteral">

/**
 * The node type for the ESTree `ThisExpression` node.
 */
export type ThisExpression = ast.NodeOfType<ES2019, "ThisExpression">

/**
 * The node type for the ESTree `ThrowStatement` node.
 */
export type ThrowStatement = ast.NodeOfType<ES2019, "ThrowStatement">

/**
 * The node type for the ESTree `TryStatement` node.
 */
export type TryStatement = ast.NodeOfType<ES2019, "TryStatement">

/**
 * The node type for the ESTree `UnaryExpression` node.
 */
export type UnaryExpression = ast.NodeOfType<ES2019, "UnaryExpression">

/**
 * The node type for the ESTree `UpdateExpression` node.
 */
export type UpdateExpression = ast.NodeOfType<ES2019, "UpdateExpression">

/**
 * The node type for the ESTree `VariableDeclaration` node.
 */
export type VariableDeclaration = ast.NodeOfType<ES2019, "VariableDeclaration">

/**
 * The node type for the ESTree `VariableDeclarator` node.
 */
export type VariableDeclarator = ast.NodeOfType<ES2019, "VariableDeclarator">

/**
 * The node type for the ESTree `WhileStatement` node.
 */
export type WhileStatement = ast.NodeOfType<ES2019, "WhileStatement">

/**
 * The node type for the ESTree `WithStatement` node.
 */
export type WithStatement = ast.NodeOfType<ES2019, "WithStatement">

/**
 * The node type for the ESTree `YieldExpression` node.
 */
export type YieldExpression = ast.NodeOfType<ES2019, "YieldExpression">
